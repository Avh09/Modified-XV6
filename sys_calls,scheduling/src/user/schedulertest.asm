...
int main()
{
  ...
  32:	4981                	li	s3,0
    ...
    printf("Average rtime %.4f, wtime %.4f\n", (float)trtime / NFORK, (float)twtime / NFORK);
  34:	d009f753          	fcvt.s.w	fa4,s3
  38:	00001797          	auipc	a5,0x1
  3c:	8987a687          	flw	fa3,-1896(a5) # 8d0 <malloc+0xea>
  40:	18d77753          	fdiv.s	fa4,fa4,fa3
  44:	d00977d3          	fcvt.s.w	fa5,s2
  48:	18d7f7d3          	fdiv.s	fa5,fa5,fa3
  4c:	42070753          	fcvt.d.s	fa4,fa4
  50:	e2070653          	fmv.x.d	a2,fa4
  54:	420787d3          	fcvt.d.s	fa5,fa5
  58:	e20785d3          	fmv.x.d	a1,fa5
  5c:	00001517          	auipc	a0,0x1
  60:	88450513          	addi	a0,a0,-1916 # 8e0 <malloc+0xfa>
  64:	00000097          	auipc	ra,0x0
  68:	6c4080e7          	jalr	1732(ra) # 728 <printf>
    exit(0);
  6c:	4501                	li	a0,0
  6e:	00000097          	auipc	ra,0x0
  72:	31a080e7          	jalr	794(ra) # 388 <exit>
            if (n < IO) {
  76:	4791                	li	a5,4
  78:	0297c263          	blt	a5,s1,9c <main+0x9c>
                settickets(10);
  7c:	4529                	li	a0,10
  7e:	00000097          	auipc	ra,0x0
  82:	3ca080e7          	jalr	970(ra) # 448 <settickets>
                sleep(200); // IO bound processes
  86:	0c800513          	li	a0,200
  8a:	00000097          	auipc	ra,0x0
  8e:	38e080e7          	jalr	910(ra) # 418 <sleep>
            exit(0);
  92:	4501                	li	a0,0
  94:	00000097          	auipc	ra,0x0
  98:	2f4080e7          	jalr	756(ra) # 388 <exit>
                settickets(1);
  9c:	4505                	li	a0,1
  9e:	00000097          	auipc	ra,0x0
  a2:	3aa080e7          	jalr	938(ra) # 448 <settickets>
                for (volatile int i = 0; i < 1000000000; i++) {
  a6:	fc042223          	sw	zero,-60(s0)
  aa:	fc442703          	lw	a4,-60(s0)
  ae:	2701                	sext.w	a4,a4
  b0:	3b9ad7b7          	lui	a5,0x3b9ad
  b4:	9ff78793          	addi	a5,a5,-1537 # 3b9ac9ff <base+0x3b9ab9ef>
  b8:	fce7cde3          	blt	a5,a4,92 <main+0x92>
  bc:	873e                	mv	a4,a5
  be:	fc442783          	lw	a5,-60(s0)
  c2:	2785                	addiw	a5,a5,1
  c4:	fcf42223          	sw	a5,-60(s0)
  c8:	fc442783          	lw	a5,-60(s0)
  cc:	2781                	sext.w	a5,a5
  ce:	fef758e3          	bge	a4,a5,be <main+0xbe>
  d2:	b7c1                	j	92 <main+0x92>
    for (; n > 0; n--) {
  d4:	34fd                	addiw	s1,s1,-1
  d6:	dcb9                	beqz	s1,34 <main+0x34>
        if (waitx(0, &wtime, &rtime) >= 0) {
  d8:	fc840613          	addi	a2,s0,-56
  dc:	fcc40593          	addi	a1,s0,-52
  e0:	4501                	li	a0,0
  e2:	00000097          	auipc	ra,0x0
  e6:	346080e7          	jalr	838(ra) # 428 <waitx>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 498:	47450513          	addi	a0,a0,1140 # 908 <digits>
 49c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 564:	3a8b8b93          	addi	s7,s7,936 # 908 <digits>
 ...
 6a4:	26090913          	addi	s2,s2,608 # 900 <malloc+0x11a>
        while(*s != 0){
